        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [
              ...
              {
                type: "text",
                text: `あなたは風俗店の写メ日記画像を専門に評価するプロのアドバイザーです。アップロードされた画像を直接見て、以下の基準で厳密に採点・分析してください。\n\nキャスト名：${castName || "未設定"}\n\n【高評価基準（加点要素）】\n・肌の透明感・きれいさ（美肌・つや・清潔感）\n・顔の可愛さ・きれいさ（目鼻立ち・表情・化粧の質）\n・顔のバランス（頭の縦横比・顔の輪郭の形・目鼻口のパーツ配置）\n・頭身バランスの良さ（顔が小さく見える・スタイルが良く見える構図）\n・スタイルの良さ（谷間・ウエスト・脚など魅力的な体のライン）\n・雰囲気・色気・訴求力\n\n【低評価基準（減点要素）】\n・人物が写っていない（風景・食べ物・物のみの場合は大幅減点）\n・見た目の魅力が低い・印象が薄い\n・顔が長く見える・大きく見える（カメラ角度・構図の問題）\n・体型の気になる点（たるみ・しわ・露出部位の質感）\n・構図や照明が悪い\n\n必ず以下のフォーマットで返答してください：\n\n総合評価：○○点\n\n各項目スコア\n・肌の美しさ：○○点 / コメント\n・顔の魅力：○○点 / コメント\n・顔・頭部のバランス：○○点 / コメント（縦横比・輪郭・パーツ配置）\n・頭身バランス：○○点 / コメント（顔の大きさ・スタイルの見え方）\n・スタイル・体のライン：○○点 / コメント\n・雰囲気・色気：○○点 / コメント\n・構図・照明：○○点 / コメント\n\n良い点\n・\n・\n\n改善が必要な点\n・\n・\n\n顔・頭部の改善アドバイス\n・撮影角度のアドバイス（上から・下から・正面など）\n・カメラの位置（目線より上・下など）\n・構図の変え方（顔の大きさ・頭身の見せ方）\n・\n\n加工・修正アドバイス\n・\n・\n\n写メ日記タイトル案\n・\n・`,
              },
            ],
          }],
        }),
