            ...
            body: JSON.stringify({
              ...
              messages: [{
                ...
                content: [
                  ...
                  { type: "text", text: `あなたはヘブンの写メ日記専門の画像アドバイザーです。お客様が「会いたい」と思える写真にするため、簡潔で実用的なアドバイスをしてください。\n\nキャスト名：${castName || "未設定"}\n\n以下の2項目だけを短く出力してください。長い説明は不要です。\n\n✨ 良い点（1〜2個）\n・この写真の魅力的なポイントを簡潔に\n\n📸 改善ポイント（最大3個）\n・女の子がすぐ実行できる具体的なアドバイスのみ（角度・明るさ・ポーズ・加工など）\n\n※細かい項目分けや長い分析は不要。パッと読めるシンプルな文体で。` },
                ],
              }],
            }),
          }))
