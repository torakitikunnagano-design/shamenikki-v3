            ...
            <div>
              <div style={{ position: "relative" }}>
                <img
                  src={imagePreviewUrl}
                  alt="プレビュー"
                  style={{ width: "100%", maxHeight: "400px", objectFit: "contain", borderRadius: "14px", border: `1.5px solid ${C.border}`, display: "block", background: "#f8f0f6" }}
                />
                <button
                  type="button"
                  onClick={clearImage}
...
function ImagePage({ casts, loggedInCast }) {
  ...
  const criteria = ["肌の美しさ", "顔の魅力", "スタイル", "雰囲気・色気"];
